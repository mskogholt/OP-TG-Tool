...
import io.Reader;
import io.Writer;
import managers.AlternativeManager;
 ...
 *
 */
public class OfficePalaceAlternative {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			try {
				AlternativeManager manager = new AlternativeManager(panel, messenger, queries, id, writer);
